...
const shoppingCart1 = [];
const wishList1 = [hoodie, tearsOfChios, wideYogaMat, travelBackpack, slimFoldWallet];
const expected1 = [hoodie, tearsOfChios, wideYogaMat, travelBackpack, slimFoldWallet];
...
const expected2 = [tearsOfChios, assamBlackTea, hoodie, chairArmrestPads, officeChair];
...
const mergeCartsWithMap = (shoppingCart = [], wishList = []) =>
  // Create an array from the hash map's values
  Array.from(
    shoppingCart
      .concat(wishList)
      // reduce merged list to a hashMap to dedupe by id.
